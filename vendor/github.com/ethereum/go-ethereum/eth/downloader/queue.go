...
type queue struct {
	...
	headerTaskPool  map[uint64]*types.Header       // [eth/62] GetPending header retrieval tasks, mapping starting indexes to skeleton headers
	...
	blockTaskPool  map[common.Hash]*types.Header // [eth/62] GetPending block (body) retrieval tasks, mapping hashes to headers
	blockTaskQueue *prque.Prque                  // [eth/62] Priority queue of the headers to fetch the blocks (bodies) for
	blockPendPool  map[string]*fetchRequest      // [eth/62] Currently pending block (body) retrieval operations
	blockDonePool  map[common.Hash]struct{}      // [eth/62] Set of the completed block (body) fetches

	receiptTaskPool  map[common.Hash]*types.Header // [eth/63] GetPending receipt retrieval tasks, mapping hashes to headers
