...
func NewLesServer(eth *eth.Ethereum, config *eth.Config) (*LesServer, error) {
	...
	pm, err := NewProtocolManager(eth.BlockChain().Config(), false, ServerProtocolVersions, config.NetworkId, eth.GetEventMux(), NewPeerSet(), eth.BlockChain(), eth.GetTxPool(), eth.GetChainDb(), nil, nil, quitSync, new(sync.WaitGroup))
	if err != nil {
		return nil, err
	}
