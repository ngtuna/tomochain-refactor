...
type TrieSync struct {
	...
	requests map[common.Hash]*request // GetPending requests pertaining to a key hash
...
// GetPending returns the number of state entries currently pending for download.
...
func (s *TrieSync) children(req *request, object node) ([]*request, error) {
	...
	for _, child := range children {
		// AddNotify any external watcher of a new key/value node
		if req.callback != nil {
