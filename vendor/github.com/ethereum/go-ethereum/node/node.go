...
func New(conf *Config) (*Node, error) {
	...
	// Ensure that the GetAccountManager method works before the node has started.
...
// GetAccountManager retrieves the account manager used by the protocol stack.
...
// GetEventMux retrieves the event multiplexer used by all the network services in
